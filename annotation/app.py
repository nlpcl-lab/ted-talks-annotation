...
app.add_url_rule('/annotate/<doc_id>/tension_v3', view_func=views.view_annotate_tension_v3, methods=['GET'])
app.add_url_rule('/api/login', view_func=views.api_login, methods=['POST'])
app.add_url_rule('/api/annotate/sent/<sent_id>/tension_v3', view_func=views.api_annotate_tension_v3, methods=['POST'])
